  ...
  return (
          ...
          <div className="container mx-auto md:py-5 flex px-5 py-24 md:flex-row flex-col items-center">
              ...
              <div className="flex justify-center mt-10 flex-col w-30 rounded-2xl text-center">
                          <a href='https://aryanpamwani.netlify.app' className="inline-flex text-white bg-indigo-500 rounded-xl border-0 py-2 px-6 focus:outline-none hover:bg-indigo-600  text-lg">{props.Button}</a> 
